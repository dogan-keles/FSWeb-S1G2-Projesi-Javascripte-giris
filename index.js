...
*/
let stringDegerimiz = "1999";

function convertToNumber(stringDegerimiz) {
  return parseInt(stringDegerimiz);
}

console.log("İnteger Hali: ", convertToNumber(stringDegerimiz));
/*
Görev 1d - Çarpma
...
function bilgisayarinSecimi() {
  ...
  if (computerChoise < 0.3333) {
    return "Taş" ; 
  } else if (computerChoise > 0.3333 && computerChoise < 0.6666) {
    return "Kağıt"; 
  } else {
    return  "Makas" ;
  }
  }
console.log("Bilgisayarın Seçimi: ", bilgisayarinSecimi())
...
console.log("Mil Dönüşümü: " + milDonusturucu(80));
...
console.log("Feet dönüşüm: " + feetDonusturucu(100))
...
const yaramazMaymunlar = 5;
for (let i = yaramazMaymunlar; i > 0; i--) {
